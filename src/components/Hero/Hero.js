    ...
    <Box className='flex justify-center items-center'>
      <Box className='flex flex-col pt-10 px-4 md:pt-14'>
        ...
        <a href='https://drive.google.com/file/d/1tqRMCQP1My5vcowOWVNSzGXqWOsSGRB1/view?usp=sharing' className='mt-6 bg-orange w-0'>
          <motion.button 
            className='transtition duration-300 bg-transparent hover:bg-green text-white font-poppin font-medium border border-green hover:border-transparent md:text-sm px-11 py-3 text-sm md:px-11 md:py-3 shadow-[5px_5px_0px_0px_rgba(255,255,255,255)]  hover:shadow-[0_0px_0px_0px_rgba(255,255,255,255)]'
            initial = {{translateY:20, opacity:0}}
            animate = {{translateY:0, opacity:1}}
