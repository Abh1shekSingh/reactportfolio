...
const Footer = () => {
  return (
    <div id='contact' className='text-center md:mx-auto pt-24 px-10 md:px-48 md:mt-24'>
       ...
       <div>
          <p className='text-white opacity-75 text-lg md:text-lg md:px-80 '>Let's Connect & Talk. Though I&apos;m a university student, but, if you have any question or query, feel free ask.</p>
       </div>
